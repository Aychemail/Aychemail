...
<html lang="en">
 <head>
  ...
  <link rel="stylesheet" href="js and css/accountstyle.css">
  <script type="text/javascript" src="js and css/accountscript.js"></script>
 </head>
 <body><form action="ACCOUNT.PHP" method="post">
	<div class="mymail"><img src="images/mymail.jpg" width="150" height="50" border="0" alt=""></div>
	<div id="top"><a href="LOGIN.PHP">Sign In</a></div>
	<font size=15px ><div class="acc"><center>Create Your Account</center></div></font>

	<div id="comp"><center><img src="images/welcome2mymail.png" width="400" height="200" border="0" alt=""><br>
	<img src="images/comp.png" width="300" height="172" border="0" alt="">
	</center>
	</div>
	<div class="abc">
